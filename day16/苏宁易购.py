...
# 点击商品,打开新的窗口
chromeDriver.find_element(By.NAME,"ssdsn_search_pro_pic02-1_0_0_12313015493_0000000000").click()
time.sleep(3)
# 切换到新打开的窗口定位元素，两种方法
...
time.sleep(3)
# 点击加入购物车
chromeDriver.find_element(By.NAME,"item_12313015493_gmq_buy01").click()
# 点击去购物车结算
