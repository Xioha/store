...
否则的话拨通。结束后，按照时间长度扣费并返回扣费（0~10分钟：1元/钟、15个积分/钟，10~20分钟：0.8元/钟、39个积分/钟，其他：0.65元/钟、
48个积分/钟））
...
class people:
    ...
    def show(self):
        print('姓名',self.__name,'\n性别',self.__gender,'\n年龄',self.__age,'\n所拥有的手机话费',self.__cost,'元！\n手机品牌：',
              self.__brand,'\n手机电池容量：',self.__battery,'%\n屏幕大小',self.__size,'寸\n最大待机时长',self.__standby,
              '分钟\n所拥有的积分：',self.__integral)
